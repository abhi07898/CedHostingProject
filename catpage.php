...
<body>
<?php 
if ($menu="windowshosting");
require 'header.php';?>
    <!---header--->
        <!---singleblog--->
                <div class="content">
                    <div class="linux-section">
                        <div class="container" id ='dayanamic_data'>
                            
                        </div>
                    </div>
                    <div class="tab-prices" id="tab_prices">
                        <div class="container">
                            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        ...
                                        <div id="dayanamic-contetn-data-price">
...
<!-- this is the last and peak point -->
                    <!-- clients -->
                <div class="clients">
                    <div class="container">
    ...
    <script>
        $(document).ready(function(){
            var tbl_id = id;
            var action = 'fetching_dayanamic_data';
            $.ajax({
                url : 'ajaxaction.php',
                type : 'post',
                dataType :'json',
                data : {id:tbl_id, action:action},
                success : function(data) {
                    $('#dayanamic_data').html(data[0]['html']);
                }
            })
            // fetching data from both table
            var tbl_id = id;
            var action = 'fetching_dayanamic_data_from_both_table';
            $.ajax({
                url : 'ajaxaction.php',
                type : 'post',
                dataType :'json',
                ...
                success : function(data) {
                    ...
                    for(var i =0; i<data.length; i++) {
                        ...
                        html+= '<div class="col-md-3 linux-price">\
                                                    <div class="linux-top">\
                                                    <h4>'+data[i]['prod_name']+'</h4>\
                                                    </div>\
                                                    <div class="linux-bottom">\
                                                        <h5> $ '+data[i]['mon_price']+'<span class="month"></span></h5>\
                                                        <h6>Single Domain</h6>\
                                                        <ul>\
                                                        <li><strong>'+disc.Free_Domain+'</strong> Free Domain</li>\
                                                        <li><strong>'+data[i]['annual_price']+'</strong> Annual Price</li>\
